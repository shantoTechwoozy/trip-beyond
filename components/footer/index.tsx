...
const Footer = () => {
  return (
    <footer className="bg-[#1E1E5B] text-orange-400">
      <div className="grid grid-cols-1 gap-8 p-10 lg:grid-cols-6 lg:gap-10 lg:p-20">
          ...
          <ul className="mt-6 space-y-4 text-sm">
            ...
            <li>
              ...
              <div className="flex mt-2">
                <Input className="w-[200px]" placeholder="Email ID" />
                <Button
                  className="rounded-full bg-[#FF9C00] hover:bg-orange-500/90 active:border-b-0 text-black px-4 py-2 ml-2"
                  variant="custom"
                >
                  Subscribe
                </Button>
