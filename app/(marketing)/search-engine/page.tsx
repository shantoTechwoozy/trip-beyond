...
export default function SearchEngine() {
  ...
  return (
    <div className="w-full max-w-screen-xl mt-5">
      <div className="flex flex-wrap justify-center py-2 text-center text-lg italic text-slate-100 space-x-4 sm:space-x-8">
